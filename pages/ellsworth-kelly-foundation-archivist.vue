  ...
  <section class="w-full">
    ...
    <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 pb-16">
      ...
      <figure class="mt-8 rounded-2xl border border-foreground/10 bg-foreground/5 h-64 sm:h-80 w-full overflow-hidden flex items-center justify-center">
        <img src="/ellsworth-project-3.png" alt="Jennifer standing in Ellsworth's Studio">
      </figure>

      <!-- Section 1 -->
      <article class="prose prose-neutral dark:prose-invert max-w-none mt-8 space-y-4" >
      ...
      <article class="prose prose-neutral dark:prose-invert max-w-none mt-8 space-y-4" >
        ...
        <p>
          To meet project goals, the internship team maintained a production target of <strong>25 files per week</strong>, or approximately <strong>8–9 files per intern</strong>, ensuring all Carlson Fabrication Files were digitized by the end of the program.
        </p>
      ...
      <!-- Image placeholder -->
      <figure class="mt-8 rounded-2xl border border-foreground/10 bg-foreground/5 h-64 sm:h-80 w-full overflow-hidden flex items-center justify-center">
        <img src="/ellsworth-project-5.png" alt="Data table with project progress">
      </figure>
