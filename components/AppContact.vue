      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <aside class="rounded-2xl border border-foreground/10 p-6 shadow-sm hover:shadow-md transition">
          ...
          <p class="mt-2 opacity-80">
            For project inquiries, collaborations, or speaking
            invitations, reach out anytime.
          </p>
            ...
            <div class="flex items-start gap-3">
              ...
              <div>
                ...
                <dd class="opacity-80">
                  ...
                  Digital Preservation · Public Art
                  Conservation
                </dd>
              </div>
            </div>
        ...
        <div class="lg:col-span-2">
          <form @submit.prevent="onSubmit"
            class="rounded-2xl border border-foreground/10 p-6 shadow-sm hover:shadow-md transition" novalidate>
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <div class="sm:col-span-2">
                ...
                <input id="org" v-model.trim="form.organization" type="text"
                  class="mt-2 w-full rounded-xl border border-foreground/15 bg-transparent px-4 py-3 outline-none focus:ring-2 focus:ring-burnt"
