    ...
    <div class="grid place-items-center md:grid-cols-2 py-16">
        <div class="px-6 space-y-8">
            ...
            <p class="sub-heading w-3/4">
                ...
                U.S. to document, transport, and care for a variety of
                collections including archaeological and cultural resource
                material, natural history specimens, and fine art. Listed below
                or linked above is detailed information about my background and
        ...
        <div class="grid place-items-center">
            <img
                src="/archives-hero.webp"
                alt="Young woman at a table with artifacts"
                class="w-3/4"
            />
        </div>
    </div>
